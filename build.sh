...
$compiler $opts -lSDL2 -lm -o bin/lib/libnyx.so -shared build/bit.o build/draw.o build/event.o build/graphics.o build/keyboard.o build/layer.o build/linear.o build/meta.o build/pack.o build/pipeline.o build/random.o build/render.o build/texture.o build/transform.o build/view.o

...
$compiler $opts -lSDL2 -lSDL2_image -lm -o bin/lib/libnyx.so -shared build/bit.o build/bitmap.o build/draw.o build/event.o build/font.o build/geom.o build/graphics.o build/keyboard.o build/layer.o build/linear.o build/list.o build/map.o build/mask.o build/meta.o build/pack.o build/pipeline.o build/random.o build/render.o build/texture.o build/transform.o build/view.o
